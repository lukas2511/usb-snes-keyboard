...
#define USBD_PID                     0x7331

#define USBD_LANGID_STRING            0x409
#define USBD_MANUFACTURER_STRING      "Chaos Computer Club Cologne"

#define USBD_PRODUCT_FS_STRING        "Test USB Device"
#define USBD_SERIALNUMBER_FS_STRING   "000000000000"

#define USBD_CONFIGURATION_FS_STRING  "Standard Configuration"
#define USBD_INTERFACE_FS_STRING      "Standard Interface"
